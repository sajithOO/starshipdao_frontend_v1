...
import { getAddresses, TOKEN_DECIMALS, AVAX_NETWORK } from "../../../constants";
...
function TimeMenu() {
    ...
    const networkID = useSelector<IReduxState, number>(state => {
        return (state.app && state.app.networkID) || AVAX_NETWORK;
    });
                        ...
                        <div className="tooltip">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("STARSHIP", TIME_ADDRESS)}>
                                        <p>STARSHIP</p>
                                    </div>
                                </div>
                            )}
